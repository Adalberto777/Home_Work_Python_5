...
def write_to_file(result_str: str, result2_str: str, file_name: str) -> None:
    with open(file_name, mode="w", encoding="utf-8") as file:
        file.write(f'Zipped text is: {result_str}' +'\n')
        file.write(f'Unipped text is: {result2_str}' +'\n')
...
write_to_file(zip_text , unzip_text, 'result_text_task_3.txt')
